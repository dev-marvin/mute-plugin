...
import static me.tuskdev.mute.inventory.PaginatedView.*;
import static me.tuskdev.mute.inventory.View.INVENTORY_ROW_SIZE;
...
//			));
	 ...
	 * @param item the item.
	 */
	public final ViewItem item(ItemStack item) {
	 ...
	 */
	@Deprecated
	public final ViewItem item(Material material) {
	 ...
	 */
	@Deprecated
	public final ViewItem item(Material material, short durability) {
	 ...
	 */
	@Deprecated
	public final ViewItem item(Material material, int amount) {
	 ...
	 */
	@Deprecated
	public final ViewItem item(Material material, int amount, short durability) {
	 ...
	 */
	public ViewSlotContext ref(String referenceKey) {
