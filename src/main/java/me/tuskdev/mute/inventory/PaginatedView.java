...
import static me.tuskdev.mute.inventory.PaginatedViewContext.FIRST_PAGE;
...
public abstract class PaginatedView<T> extends View {
	...
	private PaginatedViewSlide<T> paginatedViewSlide;
	...
	public void setSource(List<T> source) {
		this.paginatedViewSlide = new PaginatedViewSlide<>(getPageSize(), source);
	}
	...
	public PaginatedViewSlide<?> getPaginator() {
		return paginatedViewSlide;
	}

	void setPaginator(PaginatedViewSlide<T> paginatedViewSlide) {
		this.paginatedViewSlide = paginatedViewSlide;
	}
