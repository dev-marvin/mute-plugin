...
import static me.tuskdev.mute.inventory.View.UNSET_SLOT;
...
public class PaginatedViewContext<T> extends ViewContext {
	 ...
	 */
	@SuppressWarnings("unchecked")
	PaginatedViewSlide<T> getPaginator() {
		final PaginatedViewSlide<T> paginatedViewSlide = (PaginatedViewSlide<T>) ((PaginatedView<T>) view).getPaginator();
	...
	public void setSource(List<?> source) {
		...
		view.setPaginator(new PaginatedViewSlide(
